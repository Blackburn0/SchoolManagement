...
urlpatterns = [
    ...
    path('index',views.index_view,name=''), ###### url for home page ( put user registration page here)
    path('',views.welcome_view,name=''),
    ...
    path('studentsignupconfirmation', LoginView.as_view(template_name='school/studentsignupconfirmation.html')),
